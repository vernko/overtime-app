...
describe 'navigate' do
  ...
  describe 'index' do
    ...
    it 'has a scope so that only post creators can see their posts' do
      ...
      other_user = User.create(first_name: 'Non', last_name: 'Authorized', email: "nonauth@fake.com", password: "asdfasdf", password_confirmation: "asdfasdf")
  ...
  describe 'edit' do
    ...
    it 'cannot be edited from a non authorized user' do
      logout(:user)
